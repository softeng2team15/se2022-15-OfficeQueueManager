CREATE TABLE IF NOT EXISTS TICKETS(TicketID INTEGER NOT NULL PRIMARY KEY,Date VARCHAR NOT NULL,CounterID INTEGER NOT NULL,ServiceID INTEGER NOT NULL,Status VARCHAR NOT NULL);
